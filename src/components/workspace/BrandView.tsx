      ...
      <div className="h-full overflow-auto p-6">
        <div className="max-w-4xl mx-auto animate-pulse">
          <div className="flex items-center gap-6 mb-8">
            <div className="w-28 h-28 rounded-2xl bg-zinc-200 dark:bg-zinc-700" />
            <div className="flex-1">
              <div className="w-48 h-8 bg-zinc-200 dark:bg-zinc-700 rounded mb-3" />
    ...
    return (
      <div className="h-full flex flex-col items-center justify-center">
        <div className="w-24 h-24 rounded-2xl border-2 border-dashed border-zinc-300 dark:border-zinc-600 flex items-center justify-center mb-4">
          <Sparkles size={40} className="text-zinc-300 dark:text-zinc-600" />
        </div>
  ...
  return (
    <div className="h-full overflow-auto">
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center gap-6 p-6 rounded-2xl bg-white dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700">
          <div className="w-28 h-28 rounded-2xl overflow-hidden bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-700 flex items-center justify-center shadow-lg flex-shrink-0">
            <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Color Palette */}
          <div className="p-5 rounded-xl bg-white dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700">
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                />
                <p className="text-xs text-zinc-500 dark:text-zinc-400 text-center">Primary</p>
              ...
              <div className="flex-1">
                ...
                />
                <p className="text-xs text-zinc-500 dark:text-zinc-400 text-center">Secondary</p>
              ...
              <div className="flex-1">
                ...
                />
                <p className="text-xs text-zinc-500 dark:text-zinc-400 text-center">Accent</p>
          ...
          <div className="p-5 rounded-xl bg-white dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700">
            ...
            <div className="space-y-3">
              <div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 mb-1">Font Family</p>
                <p className="text-xl font-medium text-zinc-900 dark:text-white" style={{ fontFamily: identity.font }}>
                  {identity.font}
                </p>
              </div>
              <div className="text-xl font-bold text-zinc-900 dark:text-white leading-snug" style={{ fontFamily: identity.font }}>
        ...
        {businessPlan?.valueProposition && (
          <div className="p-5 rounded-xl bg-violet-50 dark:bg-violet-900/20 border border-violet-100 dark:border-violet-800">
            <div className="flex items-center gap-2 mb-3">
              <Target size={18} className="text-violet-500" />
              <h3 className="text-sm font-semibold text-violet-700 dark:text-violet-300 uppercase tracking-wide">
                Value Proposition
              </h3>
            </div>
